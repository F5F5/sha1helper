        ...
        for (let line of textLines) {
            ...
            if (r.state) {
                ...
                if (nameSeparator) {
                    ...
                    console.log(r.fileItem.name)
                    var arr = emojiUtils.toArray(r.fileItem.name)
                    console.log(arr)
                    var idx = arr.lastIndexOf('.')
                    r.fileItem.formatedName = arr.map((c,i) => {
                        if(i < idx) {
                            return c + nameSeparator
                        }
                        return c
                    }).join("")
                    console.log(r.fileItem.formatedName)
                } else {
